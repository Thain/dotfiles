...
(load-file (expand-file-name "extra/keybinds.el" doom-user-dir))
(load-file (expand-file-name "extra/org-mode.el" doom-user-dir))
(load-file (expand-file-name "extra/LaTeX.el" doom-user-dir))
#+end_src
* Modules
